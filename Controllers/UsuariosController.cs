...
namespace WebAPITickets.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public async Task<ActionResult<Usuarios>> PostUsuario(Usuarios usuario)
        {
            ...
            // usuario.us_clave = HashPassword(nuevaClave);
        ...
        [HttpPost("Autenticar")]
        public async Task<ActionResult<Usuarios>> AutenticarUsuario([FromBody] CredencialesUsuario credenciales)
        {
            var usuario = await _contexto.Usuarios
                .FirstOrDefaultAsync(u => u.us_correo == credenciales.Correo && u.us_clave == credenciales.Clave);
    ...
    // Clase para recibir las credenciales de autenticación
